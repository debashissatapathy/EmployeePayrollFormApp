    ...
    <tr>
        ...
        <td>
            <img id="${empPayrollData._id}" onclick="remove(this)" 
                src="Asset/deleteLogo.png" alt="delete">
            <img id="${empPayrollData._id}" onclick="update(this)"
                src="Asset/EditIcon.png"alt="edit">
        </td>
    </tr>
    `;
    }
         ...
         let empPayrollListLocal=[
            {
                 ...
                 _profilePic: 'Asset/passport2.jpg'
            },
            {
                 _name:'Shreya Pattnaik',
                 _gender:'female',
                 _department:[
                     'Sales'
            ],
                 ...
                 _profilePic: 'Asset/passport1.jpg'
            },
        ];
